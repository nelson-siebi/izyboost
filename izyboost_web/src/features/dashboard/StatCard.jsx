...
export default function StatCard({ label, value, icon: Icon, trend, colorClass = "bg-white" }) {
    ...
    return (
        <div
            className={`p-8 rounded-[32px] shadow-[0_15px_30px_-10px_rgba(0,0,0,0.05)] border border-slate-100/50 flex items-start justify-between relative overflow-hidden group transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] active:scale-[0.98] ${colorClass}`}
        >
