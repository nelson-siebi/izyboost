...
export default function Dashboard() {
    ...
    // We now handle loading inline for better UX
    // if (loading || !data) {
    //     return <PageLoader />;
    // }
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 space-y-6 sm:space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                    {/* Greeting & Stats */}
                    <div
                        className="lg:col-span-7 animate-[fade-in-up_0.3s_ease-out]"
                    >
                        <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">
                            <div className="space-y-6">
                                {/* Greeting */}
                                <div>
                                    <p className="text-brand-primary text-xs sm:text-sm font-semibold mb-2">Bienvenue sur votre espace</p>
                                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900">
                                        {loading ? <Skeleton className="h-10 w-48" /> : `Bonjour, ${user?.username}`}
                                    </h1>
                                </div>
                    ...
                    <div
                        className="lg:col-span-5 animate-[fade-in-up_0.3s_ease-out_0.1s_both]"
                    >
                        <div
                            ...
                            <div className="mt-auto">
                                ...
                                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight flex items-baseline gap-2 flex-wrap">
                                    {loading ? (
                                        ...
                                        <>
                                            {Number(data?.summary?.balance || 0).toLocaleString('fr-FR', { maximumFractionDigits: 0 })}
                ...
                <div className="animate-[fade-in-up_0.3s_ease-out_0.2s_both]">
                ...
                <div className="animate-[fade-in-up_0.3s_ease-out_0.3s_both]">
                    <div className="space-y-4">
                        ...
                        <div className="relative w-full overflow-hidden mask-linear-fade">
                            ...
                            <div className="flex w-max animate-marquee hover:[animation-play-state:paused] py-2">
                                {loading ? (
                                    [1, 2, 3, 4, 5, 6].map(i => (
                                        <div key={i} className="mx-2 sm:mx-3 flex-shrink-0 w-32 sm:w-40 bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
                ...
                {/* Tutorial Banner */}
                <div className="mb-8 animate-[fade-in-up_0.4s_ease-out]">
                    <TutorialCTA className="shadow-orange-500/10" />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                    {/* Quick Boost Form */}
                    <div
                        className="lg:col-span-8 animate-[fade-in-up_0.3s_ease-out_0.4s_both]"
                    >
                        <div className="h-full bg-white rounded-2xl sm:rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-sm">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
                                ...
                                {selectedService && (
                                    <div
                                        className="flex items-center gap-2 bg-emerald-50 text-emerald-600 px-3 sm:px-4 py-2 rounded-xl border border-emerald-100 animate-[fade-in-left_0.3s_ease-out]"
                                    >
                            ...
                            <form onSubmit={handleQuickOrder} className="space-y-4 sm:space-y-6">
                                ...
                                {selectedService && (
                                    <div
                                        className="overflow-hidden animate-[fade-in_0.3s_ease-out]"
                                    >
                                ...
                                {selectedService && quickOrder.quantity && (
                                    <div
                                        className="bg-slate-900 rounded-xl p-5 border border-slate-800 text-white shadow-lg animate-[fade-in-up_0.2s_ease-out]"
                                    >
                                ...
                                {formErrors.general && (
                                    <div
                                        className="flex items-center gap-2 text-red-600 text-sm font-medium bg-red-50 px-4 py-3 rounded-xl border border-red-100 animate-[shake_0.4s_ease-in-out]"
                                    >
                                        <AlertCircle size={16} />
                    ...
                    <div
                        className="lg:col-span-4 animate-[fade-in-up_0.3s_ease-out_0.6s_both]"
                    >
