document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateServiceDropdown() {
        ...
        services.forEach(service => {
            ...
            option.dataset.rate = service.rate / 1000; // Convertir le taux pour 1000 unités
...
function handleServiceChange() {
    ...
    quantityInput.value = selectedOption.dataset.min;
    ...
    document.getElementById('unitPrice').textContent = currentRate.toFixed(4); // 4 décimales
    ...
    async function handleFormSubmit(e) {
        ...
        try {
            ...
            formData.append('rate', currentRate * 1000); // Reconversion au format attendu par l'API
            ...
            showMessage(`Commande #IZY-${result.order} réussie!`, 'success');
            resetForm();
